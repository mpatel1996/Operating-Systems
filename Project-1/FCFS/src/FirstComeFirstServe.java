...
public class FirstComeFirstServe {
    ...
    public static void main(String [] argv) throws IOException {
        ...
        ArrayList<Integer> id = new ArrayList<>(); // Wait Time ArrayList
        ArrayList<Integer> wTime = new ArrayList<>(); // Wait Time ArrayList
        ArrayList<Integer> bTime = new ArrayList<>(); // job time ArrayList
